...
class ModelExtensionLiveopencartRelatedOptions extends Model {
  ...
  public function getJournal2Price($product_id, $price, $special=false) {
	...
	// get price and stock
  public function getJournalPrice($product_id, $price, $special=false, $product_info=false) {
		...
		if ($this->installed()) {
			...
			if ( $ro_settings && is_array($ro_settings) ) {
				...
				return $this->liveopencart_ext_ro->getProductPriceWithRoByProductOptions($product_id, $options, $price, $special, $product_info);
