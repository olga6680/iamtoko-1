...
<b>Импорт данных их старых версию модуля Связанные опции PRO (до версии 1.1.0) и модуля Связанные опции 2 (до версии 2.2.0)</b><br><br>
...
$_['entry_spec_ofs_help']             = 'показывать остатки или различные статусы \'Отсутствие на складе\' для комбинаций связанных опций (указанный для комбинации статус будет отображатьсян а странице товара, если покупатель выберет комбинацию связанных опций с нулевым остатком)';
...
Приобретая модуль, Вы приобретаете право его использования на одном сайте. <br>Если необходимо использовать модуль на нескольких сайтах, должна быть приобретена отдельная копия модуля для каждого сайта.<br>';
