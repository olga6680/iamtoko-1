...
$_['entry_spec_ofs_help']             = 'allow to set different Out Of Stock Status for combinations of related options (this Out Of Stock Status will be shown on the product page, when selected options combination is out of stock )';
...
$_['entry_select_first_help']         = 'select option values automatically (on the product page in the customer section)';
...
$_['entry_allow_zero_select_help']    = 'allow customer to select out of stock combinations of related options (having zero quantity)';
