	...
	$(document).on('click', 'a[data-toggle=\'image\']', function(e) {
		...
		$('#button-image').on('click', function() {
            ...
            if(!localStorage.getItem('lastFolder')) {
    			...
    			imageManagerUrl = 'index.php?route=common/filemanager&user_token=' + getURLVar('user_token') + '&thumb=' + $element.attr('id') + '&directory=' + $('#last-folder').val()+'&target=' + $element.parent().find('input').attr('id') + '';
				...
				imageManagerUrl = 'index.php?route=common/filemanager&user_token=' + getURLVar('user_token') + '&thumb=' + $element.attr('id') + '&' + directory+'&target=' + $element.parent().find('input').attr('id') + '';
